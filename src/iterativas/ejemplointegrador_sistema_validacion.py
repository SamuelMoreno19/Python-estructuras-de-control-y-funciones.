...
con las demás estructuras de control iterativo 
que hemos visto (`for`, `while`, `break`, `continue`) 
te proporciona un conjunto completo de herramientas
 para resolver prácticamente cualquier problema 
de programación que requiera repetición y control de flujo."""